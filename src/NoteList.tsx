...
export function NoteList({ availableTags, notes, onDeleteTag, onUpdateTag }: NoteListProps) {
    ...
    <EditTagsModal onUpdateTag={onUpdateTag} onDeleteTag={onDeleteTag} show={editTagsModalIsOpen} handlerClose={() => setEditTagsModalIsOpen(false)} availableTags={availableTags}/>
    </>
}
...
function EditTagsModal({ availableTags, handlerClose, show, onDeleteTag, onUpdateTag }: EditTagsModalProps){
    return (
